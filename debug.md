...
── Container ─────────────────────────────────
  ...
  socket dir:
    total 7
    drwxrwxrwt. 2 root root 3452 Aug 11 07:31 .
    drwx------. 7 root root 3452 Aug 11 07:31 ..
    srwxrwxrwx. 1 root root    0 Aug 11 07:31 X0
  xset q:
    Keyboard Control:
...
── xfce4.log ─────────────────────────────────
  ...
  wrapping the session in dbus-launch
